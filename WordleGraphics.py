...
NEW_CORRECT_COLOR = "#C5DBC4"   # Pastel green for correct letters in new color mode
NEW_PRESENT_COLOR = "#F8DFC1"   # Pastel yellow for misplaced letters in new color mode
NEW_MISSING_COLOR = "#C4B7BB"   # Pastel purple for letters that don't appear in new color mode
